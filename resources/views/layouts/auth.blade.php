...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- PLUGINS CSS STYLE -->
    <link href="{{ asset('assets/auth/plugins/nprogress/nprogress.css') }}" rel="stylesheet" /> @yield('styles')
  ...
  <body class="navbar-fixed sidebar-fixed" id="body">
    ...
    <footer class="footer mt-auto">
      {{-- <div class="copyright bg-white">
							<p>
                &copy;
								<span id="copy-year"></span> Copyright Mono Dashboard Bootstrap Template by
    ...
    <script src="{{ asset('assets/auth/js/custom.js') }}"></script> @yield('scripts')
  </body>
</html>
